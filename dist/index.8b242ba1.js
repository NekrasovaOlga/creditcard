    ...
    return function() {
        ...
        var e = {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    function r(e, a) {
                        ...
                        if (e.length > 0) {
                            ...
                            for(var s in i)for(var l in i[s])if (l === a) {
                                if (void 0 === t) for(n = 0, r = i[s][l].length; n < r; n++)o.push({
                                    ev: s,
                                    namespace: l,
                                    handler: i[s][l][n]
                                });
                    ...
                    if (c(this[0])) for(var t = this[0].eventRegistry, i = this[0], a = "string" == typeof e ? e.split(" ") : [
                        e.type
                    ], r = 0; r < a.length; r++){
                        ...
                        if (void 0 !== document && "global" === u) {
                            ...
                            if (arguments[0] = arguments[0].type ? arguments[0] : o.default.Event(arguments[0]), arguments[0].detail = arguments.slice(1), "global" === u) for(var h in t[l])for(p = 0; p < t[l][h].length; p++)t[l][h][p].apply(i, arguments);
            ...
            6030: function(e, t, i) {
                ...
                var f = {
                    ...
                    focusEvent: function(e) {
                        ...
                        i.showMaskOnFocus && r !== a.getBuffer.call(t).join("") && (0, s.writeBuffer)(n, a.getBuffer.call(t), a.seekNext.call(t, a.getLastValidPosition.call(t))), !0 !== i.positionCaretOnTab || !1 !== t.mouseEnter || o.isComplete.call(t, a.getBuffer.call(t)) && -1 !== a.getLastValidPosition.call(t) || f.clickEvent.apply(n, [
                            e,
                            !0
                ...
                var l = {
                    on: function(e, t, i) {
                        ...
                        [
                            "submit",
                            "reset"
                        ].includes(t) ? (l = l.bind(e), null !== e.form && a(e.form).on(t, l)) : a(e).on(t, l), e.inputmask.events[t] = e.inputmask.events[t] || [], e.inputmask.events[t].push(l);
                    },
                    off: function(e, t) {
            ...
            207: function(e, t, i) {
                ...
                function f(e, t) {
                    var i = 0;
                    for(var a in "+" === e && (i = r.seekNext.call(this, t.validPositions.length - 1)), t.tests)if ((a = parseInt(a)) >= i) {
                        for(var n = 0, o = t.tests[a].length; n < o; n++)if ((void 0 === t.validPositions[a] || "-" === e) && t.tests[a][n].match.def === e) return a + (void 0 !== t.validPositions[a] && "-" !== e ? 1 : 0);
                    }
                    return i;
                }
                function p(e, t) {
                    ...
                    numeric: {
                        ...
                        onBeforeWrite: function(e, t, i, a) {
                            ...
                            if (a.stripLeadingZeroes && (s = function(e, t) {
                                var i = new RegExp("(^" + ("" !== t.negationSymbol.front ? (0, n.default)(t.negationSymbol.front) + "?" : "") + (0, n.default)(t.prefix) + ")(.*)(" + (0, n.default)(t.suffix) + ("" != t.negationSymbol.back ? (0, n.default)(t.negationSymbol.back) + "?" : "") + "$)").exec(e.slice().reverse().join("")), a = i ? i[2] : "", r = !1;
                        ...
                        onKeyDown: function(e, t, i, a) {
                            ...
                            if (!e.shiftKey && (e.key === o.keys.Delete || e.key === o.keys.Backspace || e.key === o.keys.BACKSPACE_SAFARI) && i.begin !== t.length) {
                                if (t[e.key === o.keys.Delete ? i.begin - 1 : i.end] === a.negationSymbol.front) return n = t.slice().reverse(), "" !== a.negationSymbol.front && n.shift(), "" !== a.negationSymbol.back && n.pop(), r.trigger("setvalue", [
                                    n.join(""),
                                    i.begin
                                ]), !1;
                                if (!0 === a._radixDance) {
                                    ...
                                    if (a.digitsOptional) {
                                        if (0 === f) return (n = t.slice().reverse()).pop(), r.trigger("setvalue", [
                                            n.join(""),
                                            i.begin >= n.length ? n.length : i.begin
                                        ]), !1;
                                    } else if (-1 !== f && (i.begin < f || i.end < f || e.key === o.keys.Delete && (i.begin === f || i.begin - 1 === f))) {
                                        var p = void 0;
                                        return i.begin === i.end && (e.key === o.keys.Backspace || e.key === o.keys.BACKSPACE_SAFARI ? i.begin++ : e.key === o.keys.Delete && i.begin - 1 === f && (p = l.extend({}, i), i.begin--, i.end--)), (n = t.slice().reverse()).splice(n.length - i.begin, i.begin - i.end + 1), n = u(n, a.digits, a).join(""), p && (i = p), r.trigger("setvalue", [
                                            n,
            ...
            4713: function(e, t, i) {
                ...
                function p(e, t, i) {
                    var a, r, o = this, s = this.dependencyLib, l = this.maskset, u = this.opts, p = this.el, d = l.maskToken, h = t ? i : 0, v = t ? t.slice() : [
                        0
                    ], m = [], g = !1, k = t ? t.join("") : "";
                    function y(t, i, r, o) {
                        function s(r, o, c) {
                            ...
                            if (h === e && void 0 === r.matches) {
                                ...
                                if (r.isGroup && c !== r) {
                                    ...
                                    if (-1 === j || "string" == typeof j) {
                                        ...
                                        else for(A = 0; A < M.matches.length; A++)R.push(A.toString());
                                        ...
                                        for(var N = 0; N < R.length; N++){
                                            ...
                                            else if (0 === N && (D = !0), G && G.matches && G.matches.length > M.matches[0].matches.length) break;
                                            _ = m.slice(), h = B, m = [];
                                    ...
                                    } else r = s(M.matches[j] || t.matches[j], [
                                        j
                                    ].concat(o), c);
                                    if (r) return !0;
                                    ...
                                    if (r = s(Z, [
                                        ...
                                        if (m.forEach(function(t, i) {
                                            (a = b(Z, t.match) ? t.match : m[m.length - 1].match).optionalQuantifier = Y >= z.quantifier.min, a.jit = (Y + 1) * (Z.matches.indexOf(a) + 1) > z.quantifier.jit, a.optionalQuantifier && d(a, Z) && (g = !0, h = e, u.greedy && null == l.validPositions[e - 1] && Y > z.quantifier.min && -1 != [
                                                "*",
                                                "+"
                                            ].indexOf(z.quantifier.max) && (m.pop(), k = void 0), Q = !0), !Q && a.jit && (l.jitOffset[e] = Z.matches.length - Z.matches.indexOf(a));
                                        }), Q) break;
                                        return !0;
                                    }
                                }
            ...
            7215: function(e, t, i) {
                ...
                function s(e, t, i, n, o, l) {
                    ...
                    else for(; T >= 0; T--)if ((p = S.validPositions[T]) && void 0 !== p.alternation) {
                            ...
                            if (!E || !0 !== E.match.static || E.match.def !== t && t !== y.skipOptionalPartCharacter) {
                                if (y.insertMode || void 0 === b.validPositions[r.seekNext.call(g, x)] || e.end > x) {
                                    ...
                                    if (b.jitOffset[x] && void 0 === b.validPositions[r.seekNext.call(g, x)] && !1 !== (S = f.call(g, x + b.jitOffset[x], t, !0, !0)) && (!0 !== o && (S.caret = x), O = !0), e.end > x && (b.validPositions[x] = void 0), !O && !r.isMask.call(g, x, y.keepStatic && 0 === x)) {
                                        for(var T = x + 1, D = r.seekNext.call(g, x, !1, 0 !== x); T <= D; T++)if (!1 !== (S = w(T, t, i))) {
...
//# sourceMappingURL=index.8b242ba1.js.map
